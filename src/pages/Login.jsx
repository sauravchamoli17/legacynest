        ...
        <div>
            ...
            <div className="container">
                ...
                <div className="col-md-12">
                    ...
                    <h3 className="heading">Login To Legacy Nest</h3>
                    ...
                    <div className="lock">
                        ...
                        <p><span>https://</span>accounts.Legacy Nest.com/login</p>
                    </div>
                    </div>
                </div>
                <div className="col-md-12">
                <Tabs>
                    ...
                    <p className="fs-14">
                        Scan this code with the <span>Legacy Nest mobile app</span> <br />
                        to log in instantly.
                    </p>
                    </div>
                </div>
