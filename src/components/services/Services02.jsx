...
function Services02(props) {
    ...
    const [dataBlock] = useState(
        {
            heading: 'Why choose Legacy Nest',
            desc : 'Legacy Nest has a variety of features that make it the best place to start trading'
        }
    )
        ...
        <div className="container">
                ...
                <ul className="list">
                    {
                        ...
                        <li key={idx.id} className={idx.active}>
                            <div className={`icon ${idx.bg}`}>
                                <img src={idx.icon} alt="Legacy Nest" />
                            </div>
            ...
            <div className="col-xl-6 col-md-12">
...

                        {
                            dataIcon.map((data,idx) => (
                                <li className="icon" key={idx}>
                                    <Link to="#"
                                    ><img src={data.icon} alt="Legacy Nest"
                                    /></Link>
                                </li>
                            ))
                        }
                ...
                <div className="crypto-box">
                    <img className="arrow" src={arrow} alt="Legacy Nest" />
                    <div className="left">
                    <img src={bitcoin} alt="Legacy Nest" />
                    <div>
                        <h6>BTC</h6>
                        <p>+1.46%</p>
                    </div>
                    ...
                    <img src={chart} alt="Legacy Nest" />
                    </div>
                </div>
                <div className="shape"></div>
                <div className="user-card">
                    <div className="info">
                    <img src={avt} alt="Legacy Nest" />
                    <h6>Esther Howard</h6>
