                ...
                <div className="col-xl-6 col-md-12">
                    ...
                    <div className="swiper swiper-thumb1">
                        ...
                        <div className="swiper-slide">
                            <img src={avt1} alt="Legacy Nest" />
                        </div>
                        <div className="swiper-slide">
                            <img src={avt2} alt="Legacy Nest" />
                        </div>
                        <div className="swiper-slide">
                            <img src={avt3} alt="Legacy Nest" />
                        </div>
                        </div>
                    </div>
